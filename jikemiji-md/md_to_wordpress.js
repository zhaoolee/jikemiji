...
async function get_md_filename_id_dic() {
  ...
  let full_md_filename_content_length = (full_md_filename_content ? full_md_filename_content:[]).length;
  // console.log(
...
async function get_md_file_name_title_content(md_file_pathname) {
  ...
  let md_file_name = md_file_name_arr[(md_file_name_arr?md_file_name_arr:[]).length - 1];
...
async function get_top_info(md_file_pathname, key) {
  ...
  let all_content_line_length = (all_content_line?all_content_line:[]).length;
...
async function get_category_id(wordpress_token, category_str_list) {
  ...
  let category_str_list_length = (category_str_list?category_str_list:[]).length;
...
async function main() {
  ...
  let all_md_file_pathname_length = (all_md_file_pathname ? all_md_file_pathname : []).length;
